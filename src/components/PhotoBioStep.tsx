            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                    ...
                    <div className="bg-brand-black rounded-2xl p-8 backdrop-blur-sm shadow-lg border border-brand-black/20 hover:transform hover:translateY(-2px) transition-all duration-300">
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-2xl font-light text-brand-white tracking-wide">Profile Photo</h3>
                        ...
                        <div className="flex flex-col items-center space-y-8">
                            ...
                            <div className="relative group/photo">
                                <div className="w-48 h-48 border-2 border-dashed border-brand-white/20 rounded-full flex items-center justify-center overflow-hidden bg-brand-white/5 hover:border-brand-white/40 transition-all duration-300 group-hover/photo:scale-105">
                                    {photoPreview ? (
                                        <img
                                            src={photoPreview}
                                            alt="Profile preview"
                                        ...
                                        <Camera className="h-16 w-16 text-brand-white/40" />
                                    )}
                                </div>
                                <Label
                                ...
                                >
                                    <div className="bg-brand-white text-brand-black px-6 py-3 rounded-full font-medium hover:bg-brand-white/90 transition-all duration-300 transform hover:-translate-y-1 shadow-lg">
                            ...
                            <p className="text-brand-white/40 text-sm text-center">
                    ...
                    <div className="bg-brand-black rounded-2xl p-8 backdrop-blur-sm shadow-lg border border-brand-black/20 hover:transform hover:translateY(-2px) transition-all duration-300">
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-2xl font-light text-brand-white tracking-wide">About You</h3>
                            <div className="w-12 h-px bg-brand-white/20 mx-auto mt-2"></div>
                        </div>
                        ...
                        <div className="space-y-6 flex-1">
                            <div className="relative">
                                <Textarea
                                    ...
                                    rows={8}
                                    className={`bg-transparent border-2 rounded-2xl text-lg text-brand-white placeholder:text-brand-white/40 focus:ring-0 transition-all duration-300 resize-none pt-6 ${bioValidation.type === 'error'
                ...
                <div className="mb-12">
                    <Alert className="bg-brand-black border-brand-black/10 rounded-2xl backdrop-blur-sm">
                        <AlertDescription className="text-brand-white/70 text-base text-center">
                            <span className="font-medium text-brand-white">Privacy Notice:</span> Your photo and bio will be visible to anyone who visits your profile.
